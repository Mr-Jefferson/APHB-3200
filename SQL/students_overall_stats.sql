...
(SELECT	ROUND(AVG(proposal_total),2) AS overall_average,
		...
		ROUND(STDDEV(proposal_total),2) AS overall_stddev,
		students.cohort,
		students.semester,
		1 AS seminar
