...
FROM	students LEFT JOIN
        ...
        marks final_marks ON students.id_student = final_marks.id_student AND final_marks.seminar=2 AND
        proposal_marks.cohort = final_marks.cohort AND proposal_marks.semester = final_marks.semester
