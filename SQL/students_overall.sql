...
SELECT 	CONCAT(student_first_name, ' ', student_last_name) AS student_name,
        ...
        ROUND(AVG(proposal_marks.mark_1) + AVG(proposal_marks.mark_2) + AVG(proposal_marks.mark_3)*8,2) AS proposal_total,
        ...
        ROUND(AVG(final_marks.mark_1) + AVG(final_marks.mark_2) + AVG(final_marks.mark_3)*8,2) AS final_total,
