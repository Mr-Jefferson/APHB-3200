...
SELECT 	student_last_name,
        ...
        ROUND(AVG(proposal_marks.mark_1)*0.1 + AVG(proposal_marks.mark_2)*0.1 + AVG(proposal_marks.mark_3)*0.8,2)*10 AS proposal_mark_1_2_3_weighted,
        ...
        ROUND(AVG(final_marks.mark_1)*0.1 + AVG(final_marks.mark_2)*0.1 + AVG(final_marks.mark_3)*0.8,2)*10 AS final_mark_1_2_3_weighted,
        students.cohort,
        students.semester
FROM	students
