...
SELECT	TRUNCATE(AVG(proposal_marks.mark_1),2) AS proposal_mark_1_average,
        ...
        TRUNCATE(AVG(proposal_marks.mark_1)*0.1 + AVG(proposal_marks.mark_2)*0.1 + AVG(proposal_marks.mark_3)*0.8,2) AS proposal_overall_average,
        ...
        TRUNCATE(AVG(final_marks.mark_1)*0.1 + AVG(final_marks.mark_2)*0.1 + AVG(final_marks.mark_3)*0.8,2) AS final_overall_average,
